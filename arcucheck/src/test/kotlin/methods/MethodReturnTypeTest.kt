...
internal class MethodReturnTypeTest : KoinTest {
    private val controller by inject<Controller>()

    private val testClassName = "MethodReturnType"
    ...
    fun divergentReturnType_reportsDeviation_ofTypeMisimplemented() {
        ...
        assert(resultDeviationA.description.contains("return type"))
        ...
        assert(resultDeviationB.description.contains("return type"))
