...
internal class RelationAssociationTest : KoinTest {
    private val controller by inject<Controller>()

    private val testClassName = "RelationAssociation"

    private val implClassA = "src/test/kotlin/testInput/relations/a/association/"
    private val implClassB = "src/test/kotlin/testInput/relations/b/association/"

    private val designClassA = "src/test/kotlin/testInput/relations/a/association/$testClassName.puml"
    ...
    fun divergentAssociationRelation_reportsDeviation_ofTypeUnexpectedAbsent() {
        ...
        assert(resultDeviationsA.any { deviation -> deviation.description.contains("ASSOCIATION")})
